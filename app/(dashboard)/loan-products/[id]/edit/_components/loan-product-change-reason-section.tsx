  ...
  return (
    <div className="bg-white">
      ...
      <div className="p-6 space-y-4">
        ...
        {hasCriticalChanges && productStatus === 'active' && (
          <Alert className="border-yellow-200 bg-yellow-50">
            ...
            <AlertDescription className="text-yellow-700">
              <strong>Critical changes detected:</strong> You are modifying critical fields (amounts, terms, interest rate, or structure). 
              This will create a new version of the product and may affect existing applications.
            </AlertDescription>
          </Alert>
        )}
        ...
        {productStatus === 'draft' && (
          <Alert className="border-blue-200 bg-blue-50">
            ...
            <AlertDescription className="text-blue-700">
              <strong>Draft product:</strong> You can freely edit all fields without versioning concerns.
            </AlertDescription>
          </Alert>
        )}
        ...
        {/* Change Reason Input */}
        <div>
          <Label htmlFor="changeReason" className="text-sm font-medium text-midnight-blue">
            Reason for changes *
          </Label>
          <Textarea
            id="changeReason"
          ...
          <p className="text-xs text-primaryGrey-400 mt-1">
            This reason will be recorded in the product history and may be required for audit purposes.
          </p>
        </div>
      </div>
    </div>
