    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] text-center p-12">
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-2xl font-medium text-midnight-blue mb-4">Incomplete KYC-KYB Verification!</h2>
          <p className="text-primaryGrey-400 mb-8 max-w-md">
            Please ensure all required details are provided and all documents are approved to proceed to the next step.
          </p>
          <Button size="lg" onClick={() => onOpenChange(false)} className="font-normal bg-midnight-blue text-white">
            Close
          </Button>
        </div>
      </DialogContent>
