...
export type InternalApprovalCEOFormValues = z.infer<typeof formSchema>;

interface InternalApprovalCEOModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSubmit: (values: InternalApprovalCEOFormValues) => void;
  users: SimplifiedUser[];
  isLoading: boolean;
}

export function InternalApprovalCEOModal({
  open,
  onOpenChange,
  onSubmit,
  users,
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Upload final credit memo *</FormLabel>
                    <FormControl>
                      <FileUploadInput
                        value={field.value}
