...
interface NewUserGroupModalProps {
  open: boolean;
  onClose: () => void;
  onSave: (userGroup: UserGroupFormValues) => void;
}
...
export function NewUserGroupModal({
  open,
  onClose,
  onSave,
}: NewUserGroupModalProps) {
  ...
  const loanProducts = [
    { id: "loan1", name: "Business Loan" },
    { id: "loan2", name: "Personal Loan" },
    { id: "loan3", name: "Mortgage Loan" },
    { id: "loan4", name: "Education Loan" },
    { id: "loan5", name: "Auto Loan" },
  ];
      ...
      <DialogContent className="sm:max-w-4xl p-0 overflow-hidden">
        <div className="p-6">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-2xl">Create user group</h2>
              <p className="text-gray-600 mt-1">Fill in the details below to create a new user group</p>
            </div>
