              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    ...
                    result="effect1_dropShadow_6690_240611"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_6690_240611"
                    result="shape"
                  />
                </filter>
                <filter
                  id="filter1_d_6690_240611"
                  x="0"
                  y="116.864"
                  width="191.179"
                  height="55.25"
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-primaryGrey-50">
                <TableHead className="w-[200px] font-medium text-primaryGrey-500 py-4">
                  GROUP NO
                </TableHead>
                ...
                >
                  ...
                  <TableCell className="py-4">
                    <div className="text-sm text-primaryGrey-500">
                      {(group as any).businessCount ?? 0}
                    </div>
                  </TableCell>
                  <TableCell className="py-4">
                    <div className="text-sm text-primaryGrey-400">
                      {group.createdAt
                        ? new Date((group as any).createdAt).toLocaleDateString(
                            undefined,
                  ...
                  <TableCell className="py-4">
                    <div className="text-sm text-primaryGrey-400">
                      {(group as any).updatedAt
                        ? new Date((group as any).updatedAt).toLocaleDateString(
                            undefined,
                            { month: "short", day: "2-digit", year: "numeric" },
                          )
                        : "-"}
