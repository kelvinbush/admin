...
export default function UsersTable({ data, onAdd }: UsersTableProps) {
      ...
      <Card className="shadow-none border-none">
        <CardContent className="p-0">
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-primaryGrey-500 mb-6">No users linked to this group yet!</p>
            <Button
              size="lg"
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-primaryGrey-50">
                <TableHead className="w-[280px] font-medium text-primaryGrey-500 py-4">NAME</TableHead>
                <TableHead className="font-medium text-midnight-blue py-4">EMAIL</TableHead>
              ...
              {data.map((u) => (
                <TableRow key={u.id}>
                  <TableCell className="py-4">
                    <div className="text-sm text-midnight-blue">{(u as any).fullName || (u as any).name || u.id}</div>
                  </TableCell>
                  <TableCell className="py-4">
                    <div className="text-sm text-primaryGrey-500">{(u as any).email || "-"}</div>
                  </TableCell>
                  <TableCell className="py-4">
