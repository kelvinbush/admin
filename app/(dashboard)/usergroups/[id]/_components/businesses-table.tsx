          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-primaryGrey-50">
                <TableHead className="w-[280px] font-medium text-primaryGrey-500 py-4">
                  BUSINESS NAME
                </TableHead>
                  ...
                  <TableRow key={business.id}>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          {business.description && (
                            <div className="text-xs text-primaryGrey-500 line-clamp-1">
                              {business.description}
                            </div>
                          )}
                        </div>
                    ...
                    <TableCell className="py-4">
                      <div>
                        ...
                        <div className="text-xs text-primaryGrey-500">
