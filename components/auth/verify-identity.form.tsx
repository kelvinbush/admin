    ...
    return (
      <div className="space-y-4 p-6 h-full flex flex-col justify-center">
        <div className="mb-6 space-y-4">
          ...
          <h1 className="text-4xl font-bold">Verify your identity</h1>
          <p className="text-2xl text-midnight-blue">
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="w-full rounded-lg bg-white">
        <div className="mb-6 space-y-4 px-8">
          <p className="text-sm font-medium uppercase text-primary-green">
            Step 3/3
          </p>
          <h1 className="text-4xl font-bold">Verify your identity</h1>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
                  ...
                  {documentType === "passport" ? (
                    ...
                    <>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel required>Upload back ID image</FormLabel>
                            <FormControl>
                              <UploadField
                                onChange={field.onChange}
                                value={field.value}
            ...
            <div className="px-8">
              <Button type="submit" className="w-full py-6" disabled={!isValid}>
                Continue
              </Button>
            </div>
          </form>
