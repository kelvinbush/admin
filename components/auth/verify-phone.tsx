...
const VerifyPhone = () => {
  ...
  return (
    <div className={"flex flex-col"}>
      <div
        className={
          "flex flex-1 flex-col justify-center gap-2 p-9 text-center font-medium text-midnight-blue"
        }
      >
        <img
        ...
        <p className={"text-2xl font-normal"}>
          ...
          <span
            className={
              "text-2xl font-medium text-primary-green inline-flex items-center gap-2"
            }
          >
        ...
        <div className="mt-2 rounded-lg border p-4 text-left">
          <p className="text-sm">
